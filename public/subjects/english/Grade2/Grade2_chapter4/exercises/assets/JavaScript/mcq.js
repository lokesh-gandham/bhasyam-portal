const quizData = [
  {
    q: "Q1. Who did not have a king?",
    img: "assets/images/mcq-1(1).png",
    options: [
      "assets/images/people.png|People",
      "assets/images/animals.png|Animals",
      "assets/images/children.png|Children",
      "assets/images/f.png|Forest",
    ],
    a: 1,
  },

  {
    q: "Q2. Who decided that the lion will be the king?",
    img: "assets/images/mcq-2.png",
    options: [
      "assets/images/bats.png|Bats",
      "assets/images/hawk.png|Hawk",
      "assets/images/birds.png|Birds",
      "assets/images/animals.png|Animals",
    ],
    a: 3,
  },
  ...
  {
    q: "Q3. Who made the lion the king?",
    img: "assets/images/mcq-3.png",
    options: [
      "assets/images/bats.png|Bats",
      "assets/images/animals.png|Animals",
      "assets/images/birds.png|Birds",
      "assets/images/birdsNanimals.png|Birds and animals",
    ],
    a: 3,
  },

  {
    q: "Q4. Who felt helpless?",
    img: "assets/images/mcq-4.png",
    options: [
      "assets/images/hawk.png|Hawk",
      "assets/images/bats.png|Bats",
      "assets/images/lion.png|Lion",
      "assets/images/eagle.png|Eagle",
    ],
    a: 1,
  },
];
