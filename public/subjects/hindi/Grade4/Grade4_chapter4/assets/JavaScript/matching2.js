...
/* SELECT LEFT TEXT + IMAGE */
/* LEFT SIDE TEXT + IMAGE SELECT */
...
leftBoxes.forEach(box=>{
    ...
    box.onclick = selectItem;

    /* IMAGE CLICK */

    const image =
    box.parentElement.querySelector("img");

    if(image){

        image.style.cursor = "pointer";

        image.onclick = selectItem;

    }

});

/* RIGHT SIDE IMAGE + TEXT SELECT */
...
answers.forEach(answer=>{
    ...
    const image =
    answer.parentElement.querySelector("img");
