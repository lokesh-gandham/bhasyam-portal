...
const pairs = [
  { l: "घर के बाहर", r: "न जीत यहाँ" },

  { l: "खेलना चाहा", r: "आँखें बंद करना है।" },

  { l: "एक को", r: "पकड़म-पकड़ाई" },

  { l: "बाकी को", r: "भागे फिर वह" },

  { l: "जिसे पकड़े", r: "दोस्त सब" },

  { l: "न हार यहाँ", r: "दौड़ना है।" },
];
...
const leftImages = {
  "घर के बाहर": "../assets/images/homeoutside.png",

  "खेलना चाहता": "../assets/images/play.png",

  "एक को": "../assets/images/onechild.png",

  "बाकी को": "../assets/images/groupkids.png",

  "जिसे पकड़े": "../assets/images/catch.png",

  "न हार यहाँ": "../assets/images/nolose.png",
};
...
const rightImages = {
  "न जीत यहाँ": "../assets/images/no-win.png",

  "आँखें बंद करना है।": "../assets/images/eyesclose.png",

  "पकड़म-पकड़ाई": "../assets/images/pakadampakadayi.png",

  "भागो फिर वह": "../assets/images/run.png",

  "दोस्त सब": "../assets/images/friends.png",

  "दौड़ना है।": "../assets/images/running.png",
};
...
const correctPairs = {
  ...
  "खेलना चाहा": "पकड़म-पकड़ाई",

  "एक को": "आँखें बंद करना है।",

  "बाकी को": "दौड़ना है।",

  "जिसे पकड़े": "भागे फिर वह",

  "न हार यहाँ": "न जीत यहाँ",
};
...
function drawLine(leftEl, rightEl) {
  ...
  const leftDotRect = leftEl.querySelector(".dot").getBoundingClientRect();
  const rightDotRect = rightEl.querySelector(".dot").getBoundingClientRect();
  ...
  const radius = leftDotRect.width / 2;

const startX = leftDotRect.left + leftDotRect.width - svgRect.left;
const startY = leftDotRect.top + radius - svgRect.top;

const endX = rightDotRect.left - svgRect.left;
const endY = rightDotRect.top + radius - svgRect.top;
