const quizData = [
  {
    q: "Q1. The area around our house",
    a: "NEIGHBOURHOOD",
    img: "../assets/images/ow1.png",
  },

  {
    q: "Q2. People in our neighbourhood who help and serve us",
    a: "COMMUNITY HELPERS",
    img: "../assets/images/ow2.png",
  },

  {
    q: "Q3. A community helper who grows crops and provides us with food",
    a: "FARMER",
    img: "../assets/images/ow3.png",
  },

  {
    q: "Q4. A community helper who mends our shoes",
    a: "COBBLER",
    img: "../assets/images/ow4.png",
  },

  {
    q: "Q5. A place where we keep our money safe",
    a: "BANK",
    img: "../assets/images/ow5.png",
  },
];
...
function insertLetterIntoSlot(tile, letter) {
  // stop editing answered question
...
function removeLastFilledSlot() {
  // prevent deleting after answer submitted
  if (answeredQuestions[currentQuestionIndex]) return;
