...
const quizData = [
  ...
  {
    q: "Q3. Non-vegetarians do not eat fruits.",
    a: false,
...
//      correctBtn.style.background = "#4caf50";   // ADD THIS
//   correctBtn.style.border = "3px solid green"; // ADD THIS
...
function loadQuestion() {
  ...
  if (q.answered) {
    ...
    // correctBtn stays enabled (not disabled)
  }
